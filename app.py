...
st.sidebar.markdown("---")
st.sidebar.markdown("**Справка по формату:** Программа автоматически очищает маркеры `E`, восстанавливает пропущенные ведущие нули и делит строки на блоки по 11 символов.")
